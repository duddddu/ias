package com.ias.teacherMobile.common.controller;
...
@Controller
@RequestMapping("/tm")
public class TMLoginController extends BaseController{


    @GetMapping({"/", "", "/login"})
    public String login(){
        return "teacherMobile/login";
    }
